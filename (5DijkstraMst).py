...
#12. Update the distances of neighboring vertices if a shorter path is found.
...
#
#* At every step, it selects the nearest unvisited vertex with the minimum distance.
#* It makes the best local choice to extend the shortest path.
#* Once a vertex is visited, its shortest distance is finalized and not changed.
#* The algorithm greedily builds the shortest paths from the source to all other vertices.
